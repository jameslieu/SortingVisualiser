...
namespace SortingAlgo.Tests
{
    ...
    {
        [Test]
        public void InsertionSort_Should_Sort_In_Numerical_Order()
        {
            // arrange
            var numbers = new int[]
            {
            ...
            // act
            var actual = InsertionSort.Sort(numbers);
        ...
        [Test]
        public void InsertionSort_Should_Sort_In_Numerical_Order_large_volume()
        {
            // arrange
            var numbers = new int[]
            {
